 ...
 */
export const APP_NAME: string = 'Medussa';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = 'A Farcaster mini app that simulates the popular snake game ';
 ...
 */
export const APP_TAGS: string[] = ['#snake_game'];
 ...
 */
export const APP_BUTTON_TEXT: string = 'Launch Medussa';
